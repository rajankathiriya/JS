const products = [
  ...
  function display(arrayProduct)
  {
      ...
      let productcards = arrayProduct.map(function(value,index){
        ...
        else
        {
          ...
          return (`<div class="col-4"><div class="card" style="height:100%"> 
          <img class="card-img-top" src="${value.image}" alt="Card image" style="height:80%">
          <div  class="card-body">
            <h4 class="card-title">${mytitle}</h4>
            <p class="card-title"><b>price : ${value.price}</b>  </p>
  ...
  function filterByCategory(filtercat)
  {
      const filterproducts = products.filter(function(value) {
          return value.category == filtercat
      });
  ...
  function myincrement()
  {
     if(this.value == "+")
     {
      this.parentElement.getElementsByTagName("span")[0].innerText = Number(this.parentElement.getElementsByTagName("span")[0].innerText)+1;
     }
     else
     {
      this.parentElement.getElementsByTagName("span")[0].innerText = Number(this.parentElement.getElementsByTagName("span")[0].innerText)-1;
  ...
  let d= document.getElementsByClassName("btni");
  for(let i=0;i<d.length;i++)
  {
      d[i].addEventListener("click",myincrement)
  }
